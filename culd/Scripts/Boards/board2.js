...
board2.computerPlayers.push(new gamePlayer(1, board1.boardStart, "Fancis", "wizard", "red", 8, 1, false, redWizard1List, 3, 0));
board2.computerPlayers.push(new gamePlayer(2, board1.boardStart, "Ginny", "sorceress", "purple", 10, 1, false, blackSorceress1List, 3, 0));
board2.computerPlayers.push(new gamePlayer(2, board1.boardStart, "Fred", "cavalier", "yellow", 12, 1, false, redWizard1List, 3, 0));
