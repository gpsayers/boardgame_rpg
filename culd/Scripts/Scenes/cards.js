...
masterCardList.push(new card(11, "Death Curse", "Kill target creature", 1, "uncommon", 50, false, true, 0, 0, 100, "death", 0, 3, "any", 'creature', '1', 0));
masterCardList.push(new card(12, "Blizzard", "Deal 1 damage to the entire board", 1, "uncommon", 50, false, true, 0, 0, 1, "blizzard", 0, 4, "all", 'both', 'all', 2));
...
var redWizard1List = populateCardArray([2,2,7,7,5,5,8,8,9,9,5]);

var blackSorceress1List = populateCardArray([2,2,7,7,5,5,9,9,8,8,5]);

var testPlayerCardList = populateCardArray([2, 2, 7, 7, 5, 5, 8, 8, 9, 9,1,11,12,3,3,6,6]);
